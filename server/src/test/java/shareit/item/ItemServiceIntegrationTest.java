...
class ItemServiceIntegrationTest {
    ...
    void getItem() throws Exception {
        Optional<User> owner = userRepository.findByName("owner"); // Use your own method to find user
        Long ownerId = owner.get().getId();
        Item savedItem = itemRepository.findByName("item1"); // Use your own method to find item
